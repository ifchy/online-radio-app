...
The keys live in `.claude/settings.json` (project) or `/Users/alabala/Documents/projects/personal/online-radio-app/.claude/settings.json` (global) — **not** in `.planning/config.json`:
...
See @/Users/alabala/Documents/projects/personal/online-radio-app/.claude/gsd-core/references/planner-guidance.md for Granularity Calibration table (Coarse/Standard/Fine plans-per-phase).
