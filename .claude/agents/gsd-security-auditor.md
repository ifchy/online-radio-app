...
**Verification depth scales with `asvs_level`** (see @/Users/alabala/Documents/projects/personal/online-radio-app/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
